!(function (u, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['dayjs'], e)
      : ((u = 'undefined' != typeof globalThis ? globalThis : u || self).dayjs_locale_fi = e(u.dayjs))
})(this, function (u) {
  'use strict'
  function e(u) {
  ...
  var i = {
    ...
    weekStart: 1,
    yearStart: 4,
    relativeTime: { future: '%s päästä', past: '%s sitten', s: n, m: n, mm: n, h: n, hh: n, d: n, dd: n, M: n, MM: n, y: n, yy: n },
    formats: {
      LT: 'HH.mm',
      LTS: 'HH.mm.ss',
      L: 'DD.MM.YYYY',
