!(function (Y, M) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = M(require('dayjs')))
    : 'function' == typeof define && define.amd
      ? define(['dayjs'], M)
      : ((Y = 'undefined' != typeof globalThis ? globalThis : Y || self).dayjs_locale_he = M(Y.dayjs))
})(this, function (Y) {
  'use strict'
  function M(Y) {
  ...
  var l = {
    ...
    relativeTime: { future: 'בעוד %s', past: 'לפני %s', s: _, m: _, mm: _, h: _, hh: _, d: _, dd: _, M: _, MM: _, y: _, yy: _ },
    ordinal: function (Y) {
      return Y
    },
    format: {
