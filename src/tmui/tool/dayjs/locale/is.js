!(function (u, r) {
  'object' == typeof exports && 'undefined' != typeof module
    ? (module.exports = r(require('dayjs')))
    : 'function' == typeof define && define.amd
      ? define(['dayjs'], r)
      : ((u = 'undefined' != typeof globalThis ? globalThis : u || self).dayjs_locale_is = r(u.dayjs))
})(this, function (u) {
  'use strict'
  function r(u) {
  ...
  var a = {
    ...
    relativeTime: { future: 'eftir %s', past: 'fyrir %s síðan', s: t, m: t, mm: t, h: t, hh: t, d: t, dd: t, M: t, MM: t, y: t, yy: t },
  }
