<template>
  <view v-if="_width != '0px' && _width != '0%'" :style="[_width ? { width: _width } : '']" class="flex flex-row flex-row-top-start py-6">
    <view :style="[labelWidth ? { width: labelWidth + 'rpx' } : '']" class="flex-shrink">
