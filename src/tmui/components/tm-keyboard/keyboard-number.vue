    ...
    <view>
      <tm-row :column="7" align="start">
        ...
        <tm-col :col="1" :height="420" align="start" :transprent="true" :margin="[0]">
          <tm-row :column="1">
            <tm-col @click="del" hover-class="opacity-5 " color="grey-1" :margin="[8, 0, 4, 8]" :round="props.round" :height="100" :col="1">
              <tm-icon :userInteractionEnabled="false" name="tmicon-caret-left"></tm-icon>
            </tm-col>
            <tm-col @click="confirm" hover-class="opacity-5 " :color="props.color" :margin="[8, 0, 0, 0]" :round="props.round" :height="300" :col="1">
